...
# сущности. Тип, класс, объект, атрибуты, методы класса и т.п. Объекдиняя
...
# region #* Принципы ООП ------------------------------------------------------
"""
#* SOLID принцип единственной ответственности. Каждый класс отвечает только
за одну функцию. Если необходимо расширить функцонал, лучше выделить это в
отдельный класс (когда не противоречит KISS)
