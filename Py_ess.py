...
# **Наиболее часто используемый __init__
...
class Complex:  # Странный конечно пример, на методе составных чисел
    ...
    def __repr__(self):  # возврат значений для разработчика
...
# raise команда вызывающая исключение, со ссылкной к классу исключений.
